...
$query="SELECT * FROM `tbl_delivery_details` LEFT JOIN `customer` ON tbl_delivery_details.c_id=customer.c_id ";
$type_shirt=array();
$type_pant=array();
$data=array();
...
$datass = array('shirt' => $type_shirt,'pant'=>$type_pant,'datas'=>$data );
